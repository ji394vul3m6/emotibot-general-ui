      ...
      robotModuleList: [
        {
          ...
          privCode: [],
          operation: ['all', 'create', 'edit', 'delete', 'import', 'export', 'mark', 'ignore', 'publish', 'active', 'deactive', 'cluster'],
        },
        {
          id: 'ssm',
          name: this.$t('pages.ssm.module_name'),
          privCode: ['ssm', 'qa_label'],
          operation: ['all', 'create', 'edit', 'delete', 'import', 'export'],
        },
        {
          id: 'task_engine',
          name: this.$t('pages.task_engine.module_name'),
          privCode: ['task_engine'],
          operation: ['all', 'create', 'edit', 'delete', 'import', 'export', 'publish', 'active', 'deactive'],
        },
        {
          id: 'intent_engine',
        ...
        },
        {
          ...
          operation: ['all', 'create', 'edit', 'delete', 'active', 'deactive'],
        },
      ],
    };
  },
