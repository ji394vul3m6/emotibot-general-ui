export default {
  ...
  statistics: {
    ...
    search_more_hint: '以最后一笔访问时间为启始点重新查询',
  ...
  intent_engine: {
    ...
    manage: {
      ...
      corpus_search_num: '(查询结果: {pos}笔正例/{neg}笔反例)',
    ...
    side_panel: {
      ...
      do_intent_test: {
        title: '进行意图测试',
        current_test_corpus_info: '当前测试题 {inum} 组意图 / {cnum} 笔语料，透过与测试题比对差异数量选择适合的模型进行测试。',
        select_label: '选择欲测试的意图模型',
        intent_model_header: '意图模型',
        test_corpus_header: '与测试题比对',
        model_statistics: '{inum} 组意图 / {cnum} 笔语料',
        check_diffs: '查看 {inum} 组差异',
        no_diff: '0 组差异',
        diff_info: '测试题共有 {t_inum} 组意图 / {t_cnum} 笔语料，比对 {model} 模型共有 {m_inum} 组意图 / {m_cnum} 笔语料',
