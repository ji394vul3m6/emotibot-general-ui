export default {
  ...
  robot_command: {
    ...
    editpop: {
      ...
      keyword: {
        ...
        advanced: '進階設定',
        regex: '正則式',
        keyword_placeholder: '關鍵字以 "/" 隔開, 關鍵字必須全符合才、可觸發指令',
      },
      datetime: {
        title: '生效時間',
        forever: '永遠',
  ...
  intent_engine: {
    ...
    test: {
      run_test: '進行測試',
      last_test: '最後測試時間：',
      download_prev_report: '下載歷次測試報告',
      how_to_improve: '如何優化測試數據報告？',
      test_answer: '測試題',
      test_corpus: '測試語料',
      precision: '正確率',
      robot_predict: '機器人預測',
      ...
      no_data: {
        title: '暫無測試題',
        hint_left: '左上角可手動新增，導入意圖測試題',
        hint_right: '右上角可下載測試題範本',
      },
      test_status_msg: {
        is_testing: '意圖測試進行中，已完成{percentage}%',
      },
      tooltip: {
        name_empty: '意圖名稱不可爲空',
        name_duplicate: '意圖名稱已存在',
        corpus_duplicate: '已存在相同測試語料',
        test_title: '這是測試題',
        precision: '這是正確率',
        robot_predict: '這是機器人預測',
        scoring: '這是評分',
        result: '這是結果',
      },
      notify: {
        get_test_corpus_fail: '讀取測試語料失敗',
      },
    },
  },
  pages: {
