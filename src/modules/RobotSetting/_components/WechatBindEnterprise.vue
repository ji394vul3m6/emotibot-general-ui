  ...
  <div class="wechat-enterprise-wrapper">
    ...
    <div class="input-area">
      ...
      <div class="line">
        ...
        <info-input v-model="agentId"
        :msg="$t('robot_setting.tip_agent')"
        :placeholder="$t('robot_setting.search_keyword')"></info-input>
      </div>
      <div class="line">
        <span class="input-label">Secret</span>
        <info-input v-model="secret"
        :msg="$t('robot_setting.tip_secret')"
        :placeholder="$t('robot_setting.search_keyword')"></info-input>
      </div>
      <text-button class="generate-btn" :button-type="enableGenerate?'fill':'disable'" @click="handleBindEntWechat">{{$t('robot_setting.generate')}}</text-button>
