...
<div id="action-card" class="action-card">
  <div id="webhook-action" class="action-block" v-if="action.type=='webhook'">
    <div class="title margin-top-bottom">{{$t("action_card.webhook.label_call_webhook")}}</div>
    <div class="webhook-row-container row-container margin-top-bottom" v-if="action.type=='webhook'">
      <div class="left-half input-label">{{$t("action_card.webhook.label_variable")}}</div>
      <div class="right-half">
        <input v-model="action.variable_name" class="input" :placeholder="$t('action_card.webhook.placeholder_input_variable_name')"></input>
        <div class="input-label select-method-label">{{$t("action_card.webhook.label_method")}}</div>
    ...
    <div class="webhook-row-container row-container margin-top-bottom">
      <div class="left-half input-label">{{$t("action_card.webhook.label_url")}}</div>
      <div class="right-half">
        <input v-model="action.url" class="input input-url" :placeholder="$t('action_card.webhook.placeholder_input_url')"></input>
      </div>
    </div>
    <div class="webhook-row-container row-container margin-top-bottom" v-if="action.method!='GET'">
      <div class="left-half input-label">{{$t("action_card.webhook.label_header_content_type")}}</div>
      <div class="right-half">
        <v-select v-model="action.contentTypes" :options="contentTypes" :searchable="false"></v-select>
      </div>
    </div>
    <div class="webhook-row-container row-container margin-top-bottom" v-if="action.method!='GET'">
      <div class="left-half input-label">{{$t("action_card.webhook.label_body")}}</div>
      <div class="right-half">
        <input v-model="action.body" class="input input-body" :placeholder="$t('action_card.webhook.placeholder_input_body')"></input>
      </div>
    </div>
  </div>

  <div id="msg-action" class="action-block" v-if="action.type=='msg'">
    <div class="title margin-top-bottom">{{$t("action_card.msg.label_msg_return")}}</div>
    <div class="msg-row-container row-container margin-top-bottom" v-if="action.type=='msg'">
      <div class="left-half input-label">{{$t("action_card.msg.label_return_msg")}}</div>
      <div class="right-half">
  ...
  <div id="goto-action" class="action-block" v-if="action.type=='goto'">
    <div class="title margin-top-bottom">{{$t("action_card.goto.label_goto_next_skill")}}</div>
    <div class="goto-row-container row-container margin-top-bottom" v-if="action.type=='goto'">
      <div class="left-half input-label">{{$t("action_card.goto.label_goto")}}</div>
      <div class="right-half">
        <v-select
        ...
        <button class="btn-basic btn-hightlight-border" @click="addNewSkill">{{$t("action_card.goto.button_add_new_task")}}</button>
      </div>
    </div>
  </div>
</div>
